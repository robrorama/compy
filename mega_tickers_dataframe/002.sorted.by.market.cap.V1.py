...
# Load the dataset
file_path = 'input_file.csv'  # Replace with your file path
df = pd.read_csv(file_path)

# Ensure 'marketCap' is treated as a numeric value, handling missing or non-string data
df['marketCap'] = pd.to_numeric(df['marketCap'].str.replace(',', '').str.replace('$', ''), errors='coerce')
