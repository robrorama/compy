...
def plot_data(df, high_volume_days, ticker, period_name, start_date):
    ...
    # Add high-volume day markers
    fig.add_trace(go.Scatter(x=high_volume_days.index, y=high_volume_days['Adj Close'], 
                             mode='markers', marker=dict(size=high_volume_days['MarkerSize'], color='red', symbol='circle'),
                             name='High Volume (Z > 2)'), row=1, col=1)
