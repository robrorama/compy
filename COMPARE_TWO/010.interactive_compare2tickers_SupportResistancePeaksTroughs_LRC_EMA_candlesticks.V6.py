...
def load_or_download_data(ticker, period):
...
def main():
    if len(sys.argv) != 4:
        print("Usage: python ip_interactive_compare2tickersSupportResistPeakTroughs_LRC_EMA_candlesticks.v5.py <ticker1> <ticker2> <period>")
        sys.exit(1)
